...
import { LinkedinOutlined, GithubOutlined, TwitterOutlined, MailOutlined, EnvironmentOutlined, SkypeOutlined, PhoneOutlined } from '@ant-design/icons';
...
const Canvas: React.FC = () => {
    return (
        <PageContainer id='resume-content'>
            <div id='cv-header'>
                <div id='user-info'>
                    <p id='name' style={{ fontSize: 35, margin: 0 }}>Mohamed Ali Ben Othmen</p>
                    <p id='title' style={{ fontSize: 25, color: '#2d3436', marginBottom: 15, marginTop: 0 }}>Software Engineer</p>
                    <p id='summary' style={{ fontSize: 14 }}>
                        Enthusiastic software engineer with 3+ years experience participating in the complete product development lifecycle of successfully launched applications. Proficient in an assortment of technologies, including JavaScript, TypeScript, React, Node.js, and PostgreSQL.
                    </p>
                </div>
                <div id='social-media' style={{ background: '#192a56', marginTop: 20, display: 'flex', flexWrap: 'wrap', padding: '13px 5px 0px 10px' }}>
            ...
            <div id='skills'>
                ...
                <ul style={{ fontSize: 14 }}>
                    <li><span style={{ fontWeight: 600 }}>Programming Languages</span>: JavaScript, TypeScript, Python, Ruby</li>
                    <li><span style={{ fontWeight: 600 }}>Frontend Technologies</span>: HTML, CSS, SASS, React, Redux</li>
                    <li><span style={{ fontWeight: 600 }}>Backend Technologies</span>: Node.js, Flask, Ruby on Rails, GraphQL, RabbitMQ, Kafka</li>
                    <li><span style={{ fontWeight: 600 }}>Databases</span>: MySQL, PostgreSQL, MongoDB</li>
                    <li><span style={{ fontWeight: 600 }}>TDD & BDD</span>: Selenium, Cypress, Puppeteer, Jest, Jasmine.</li>
                    <li><span style={{ fontWeight: 600 }}>DevOps</span>: Jenkins, Docker, kubernetes</li>
                </ul>
            </div>
            ...
            <div id='experience'>
                ...
                <div id='role'>
                    <p id='position' style={{ marginBottom: 0, fontSize: 20 }}>Senior Frontend Developer</p>
                    <p id='company-name' style={{ fontSize: 20, marginBottom: 10 }}>Apprentus</p>
                ...
                <div id='role'>
                    <p id='position' style={{  marginBottom: 0, fontSize: 20 }}>Full Stack Engineer</p>
                    <p id='company-name' style={{ fontSize: 20, marginBottom: 10 }}>dresslife GmbH</p>
                    <p id='date' style={{ color: 'gray' }}>
                        <i>12/2018 - 12/2019</i>
                    </p>
                    <ul id='duties'>
